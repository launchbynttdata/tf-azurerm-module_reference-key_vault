# Private vault example
 ...
 It can also be used to wire Key Vault monitoring features such as metric alerts, diagnostic settings, Log Analytics, and
...
| <a name="input_scheduled_query_alerts"></a> [scheduled\_query\_alerts](#input\_scheduled\_query\_alerts) | n/a | `any` | `{}` | no |
